  ...
  <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
    <div class="-mx-3 md:flex mb-6">
      <div class="md:w-1/2 px-3 mb-6 md:mb-0">
        ...
        <input v-model="nombreInput" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" id="grid-first-name" type="text" placeholder="Jane">
      ...
      <div class="md:w-1/2 px-3">
        ...
        <input v-model="apellidoInput"  class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="grid-last-name" type="text" placeholder="Doe">
      </div>
    </div>
    <div class="-mx-3 md:flex mb-6">
...
const handleSubmit = () => {
  store.updateUsuario({ nombre: nombreInput.value, apellido: apellidoInput.value })
  nombreInput.value = ''
  apellidoInput.value = ''
  componentStore.switchAlertState()
  setTimeout(() => componentStore.switchAlertState(), 3000)
}
</script>
